...
تاریخ به‌روزرسانی: **۲۰۲۶-۰۹-۲۵** · نسخهٔ جاری: **2.5.4**
...
- `mobile/`: Kivy + stdlib network + indicators_lite + signal_lite؛ نسخهٔ مستقل `1.9.14` (۲.۵.۴: هم‌گام‌سازی نسخه؛ ۲.۵.۳: دارایی‌های `mobile/assets` و ربات ساخت APK اصلاح شد)؛ موتور موبایل عین pipeline پنج‌استراتژی دسکتاپ نیست. این مرحله نسخه یا کد موبایل را تغییر نداده است.
